...
EXECUTE_FILE = ".PY_PRIVATE/20250922093212715"
PREFIX = sys.prefix
    ...
    
    {
      ...
      /*try:*/ {
        ...
        while (1) {
          ...
          __pyx_t_5 = PyObject_RichCompare(__pyx_v_fows, __pyx_int_0, Py_GE); __Pyx_XGOTREF(__pyx_t_5); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 485, __pyx_L5_error)
